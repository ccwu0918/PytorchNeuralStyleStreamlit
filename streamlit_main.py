...
if upload_img is not None:
    ...
    os_cmd = "python3 neural_style/neural_style.py eval --content-image  images/content-images/userinput.png --model " + model_path + " --output-image " + output_image_path + " --cuda 0"
